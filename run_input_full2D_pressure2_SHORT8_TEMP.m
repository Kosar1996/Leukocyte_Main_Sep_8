...
nSteps = 8;          % requested time steps (shortened for 08/20 quick 8-point check)
tEnd = nSteps * dt;
...
if numel(fieldnames(struct()))==0
    ...
    cfg.fluid.maxBodyFittedTractionCorrections = 10;
    ...
    cfg.parOverrides.maxBodyFittedTractionCorrections = 10;
...
out.cfg=cfg;
save('out_short8_after_dtfix.mat','out');
