%% TEST_FINESTEP_UNSTEADY_WARMSTARTFIX4_FROM_RUNB_STATE1
...
% Writes to its OWN output/log files (out_finestep_UNSTEADY_WARMSTARTFIX4.mat)
...
save('out_finestep_UNSTEADY_WARMSTARTFIX4.mat', 'outFine', '-v7.3');
fprintf('\nSaved full output to out_finestep_UNSTEADY_WARMSTARTFIX4.mat\n');

fprintf('\n=== RESULT (unsteady Stokes ON, warm-start fixes + endothelium trust-region rescaling ACTIVE) ===\n');
