...
fprintf('ORIGINAL par.newtonTolSolid = %.6e, par.newtonMaxItSolid = %d\n', par.newtonTolSolid, par.newtonMaxItSolid);
parTest.newtonTolSolid = 1e-13;
parTest.newtonMaxItSolid = max(par.newtonMaxItSolid, 200);
fprintf('TIGHTENED parTest.newtonTolSolid = %.6e, maxIt = %d\n', parTest.newtonTolSolid, parTest.newtonMaxItSolid);
