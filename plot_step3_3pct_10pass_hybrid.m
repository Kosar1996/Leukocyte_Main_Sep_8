...
fprintf('Running HYBRID, threshold=%.1f%%, maxIterations=%d ...\n', testThresholdPct, testMaxIter);
...
title(tl, sprintf('Traction-correction convergence -- Hybrid (relax=%.2f, %d passes, target=%.1f%%)', ...
...
outPng = fullfile(fileparts(mfilename('fullpath')), 'step3_3pct_10pass_hybrid.png');
